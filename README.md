...
| DL | | <li>Compute: 256 TFLOPS@FP16, 512 TOPS@INT8, <li> Memory: 64 GB,  <li> Host Interface: Dual PCIe Gen5 X16  64GB/s <li> TDP：150W                           | [DL Introduction](byte_mlperf/backends/DL/README.md) |
